...
const OfficialTimeForm = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(
        'http://localhost:5000/upload-excel-faculty-official-time',
        formData,
        {
  ...
  return (
    <Container
      sx={{ bgcolor: 'white', paddingBottom: '25px', borderRadius: '10px' }}
    >
      <div>
        <div
          style={{
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'right', gap: '1rem' }}>
            ...
            >
              ...
              {/* Add Upload icon with some right margin */}
              Upload Excel
            </Button>
          </div>
        </div>
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          >
            <SearchIcon sx={{ mr: 1 }} />{' '}
            {/* Add Search icon with some right margin */}
            Search
          </Button>
        </div>
        {loading && <p>Loading...</p>}
        {records.length > 0 && (
          <form onSubmit={handleSubmit}>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell sx={{ width: '125px', minWidth: '125px' }}>
                      Time In
                    </TableCell>
                    <TableCell sx={{ width: '125px', minWidth: '125px' }}>
                      Break In
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell sx={{ display: 'none' }}>
                        <TextField
                          ...
                          onChange={(e) =>
                            handleChange(index, 'breaktime', e.target.value)
                          }
                        />
                      </TableCell>
                    </TableRow>
            ...
            >
              <SaveIcon sx={{ mr: 1 }} />{' '}
              {/* Add Save icon with some right margin */}
              {found ? 'Update' : 'Save'}
            </Button>
          </form>
        )}
