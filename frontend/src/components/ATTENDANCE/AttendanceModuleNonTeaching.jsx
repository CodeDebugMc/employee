...
const AttendanceModuleNonTeachingStaff = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const processedData = response.data.map((row) => {
        ...
        const parsedDefaultTime = dayjs(
          `2024-01-01 ${defaultTime}`,
        ...
        const midnightFacultyAM = new Date(
          `01/01/2000 ${defaultTimeFacultyAM}`
        );
        ...
        const timeoutfacultyAM =
          timeinfacultyAM === midnightFacultyAM
            ...
            : endDateFacultyAM < startOfficialTimeFacultyAM
            ? midnightFacultyAM
            : endDateFacultyAM < endOfficialTimeFacultyAM
            ? endDateFacultyAM
            : endOfficialTimeFacultyAM;
        ...
        const tardFinalformattedFacultyRenderedTimeAM = new Date(
          `01/01/2000 ${formattedFacultyRenderedTimeAM}`
        );
        const tardFinalformattedFacultyMaxRenderedTimeAM = new Date(
          `01/01/2000 ${formattedFacultyMaxRenderedTimeAM}`
        );

        const finalcalcFacultyAM =
          tardFinalformattedFacultyMaxRenderedTimeAM -
          tardFinalformattedFacultyRenderedTimeAM;

        // Convert milliseconds to hours, minutes, seconds
        const hoursfinalcalcFacultyAM = Math.floor(
          finalcalcFacultyAM / (1000 * 60 * 60)
        );
        const minutesfinalcalcFacultyAM = Math.floor(
          (finalcalcFacultyAM % (1000 * 60 * 60)) / (1000 * 60)
        );
        const secondsfinalcalcFacultyAM = Math.floor(
          (finalcalcFacultyAM % (1000 * 60)) / 1000
        );

        // Format output as HH:MM:SS
        const formattedfinalcalcFacultyAM = [
          String(hoursfinalcalcFacultyAM).padStart(2, '0'),
          String(minutesfinalcalcFacultyAM).padStart(2, '0'),
          String(secondsfinalcalcFacultyAM).padStart(2, '0'),
        ].join(':');
        ...
        const midnightFacultyPM = new Date(
          `01/01/2000 ${defaultTimeFacultyPM}`
        );
        ...
        const timeinfacultyPM =
          startDateFacultyPM === null
            ? midnightFacultyPM
            : endDateFacultyPM < startOfficialTimeFacultyPM
            ? midnightFacultyPM
            : startDateFacultyPM > endOfficialTimeFacultyPM
            ? midnightFacultyPM
            : startDateFacultyPM < startOfficialTimeFacultyPM
            ? startOfficialTimeFacultyPM
            : startDateFacultyPM;
        ...
        const tardFinalformattedFacultyRenderedTimePM = new Date(
          `01/01/2000 ${formattedFacultyRenderedTimePM}`
        );
        const tardFinalformattedFacultyMaxRenderedTimePM = new Date(
          `01/01/2000 ${formattedFacultyMaxRenderedTimePM}`
        );

        const finalcalcFacultyPM =
          tardFinalformattedFacultyMaxRenderedTimePM -
          tardFinalformattedFacultyRenderedTimePM;

        // Convert milliseconds to hours, minutes, seconds
        const hoursfinalcalcFacultyPM = Math.floor(
          finalcalcFacultyPM / (1000 * 60 * 60)
        );
        const minutesfinalcalcFacultyPM = Math.floor(
          (finalcalcFacultyPM % (1000 * 60 * 60)) / (1000 * 60)
        );
        const secondsfinalcalcFacultyPM = Math.floor(
          (finalcalcFacultyPM % (1000 * 60)) / 1000
        );

        // Format output as HH:MM:SS
        const formattedfinalcalcFacultyPM = [
          String(hoursfinalcalcFacultyPM).padStart(2, '0'),
          String(minutesfinalcalcFacultyPM).padStart(2, '0'),
          String(secondsfinalcalcFacultyPM).padStart(2, '0'),
        ].join(':');
        ...
        const midnightFacultyHN = new Date(
          `01/01/2000 ${defaultTimeFacultyHN}`
        );
        ...
        const tardFinalformattedFacultyRenderedTimeHN = new Date(
          `01/01/2000 ${formattedFacultyRenderedTimeHN}`
        );
        const tardFinalformattedFacultyMaxRenderedTimeHN = new Date(
          `01/01/2000 ${formattedFacultyMaxRenderedTimeHN}`
        );

        const finalcalcFacultyHN =
          tardFinalformattedFacultyMaxRenderedTimeHN -
          tardFinalformattedFacultyRenderedTimeHN;

        // Convert milliseconds to hours, minutes, seconds
        const hoursfinalcalcFacultyHN = Math.floor(
          finalcalcFacultyHN / (1000 * 60 * 60)
        );
        const minutesfinalcalcFacultyHN = Math.floor(
          (finalcalcFacultyHN % (1000 * 60 * 60)) / (1000 * 60)
        );
        const secondsfinalcalcFacultyHN = Math.floor(
          (finalcalcFacultyHN % (1000 * 60)) / 1000
        );

        // Format output as HH:MM:SS
        const formattedfinalcalcFacultyHN = [
          String(hoursfinalcalcFacultyHN).padStart(2, '0'),
          String(minutesfinalcalcFacultyHN).padStart(2, '0'),
          String(secondsfinalcalcFacultyHN).padStart(2, '0'),
        ].join(':');
        ...
        const midnightFacultySC = new Date(
          `01/01/2000 ${defaultTimeFacultySC}`
        );
        ...
        const tardFinalformattedFacultyRenderedTimeSC = new Date(
          `01/01/2000 ${formattedFacultyRenderedTimeSC}`
        );
        const tardFinalformattedFacultyMaxRenderedTimeSC = new Date(
          `01/01/2000 ${formattedFacultyMaxRenderedTimeSC}`
        );

        const finalcalcFacultySC =
          tardFinalformattedFacultyMaxRenderedTimeSC -
          tardFinalformattedFacultyRenderedTimeSC;

        // Convert milliseconds to hours, minutes, seconds
        const hoursfinalcalcFacultySC = Math.floor(
          finalcalcFacultySC / (1000 * 60 * 60)
        );
        const minutesfinalcalcFacultySC = Math.floor(
          (finalcalcFacultySC % (1000 * 60 * 60)) / (1000 * 60)
        );
        const secondsfinalcalcFacultySC = Math.floor(
          (finalcalcFacultySC % (1000 * 60)) / 1000
        );

        // Format output as HH:MM:SS
        const formattedfinalcalcFacultySC = [
          String(hoursfinalcalcFacultySC).padStart(2, '0'),
          String(minutesfinalcalcFacultySC).padStart(2, '0'),
          String(secondsfinalcalcFacultySC).padStart(2, '0'),
        ].join(':');
        ...
        const midnightFacultyOT = new Date(
          `01/01/2000 ${defaultTimeFacultyOT}`
        );
        ...
        const tardFinalformattedFacultyRenderedTimeOT = new Date(
          `01/01/2000 ${formattedFacultyRenderedTimeOT}`
        );
        const tardFinalformattedFacultyMaxRenderedTimeOT = new Date(
          `01/01/2000 ${formattedFacultyMaxRenderedTimeOT}`
        );

        const finalcalcFacultyOT =
          tardFinalformattedFacultyMaxRenderedTimeOT -
          tardFinalformattedFacultyRenderedTimeOT;

        // Convert milliseconds to hours, minutes, seconds
        const hoursfinalcalcFacultyOT = Math.floor(
          finalcalcFacultyOT / (1000 * 60 * 60)
        );
        const minutesfinalcalcFacultyOT = Math.floor(
          (finalcalcFacultyOT % (1000 * 60 * 60)) / (1000 * 60)
        );
        const secondsfinalcalcFacultyOT = Math.floor(
          (finalcalcFacultyOT % (1000 * 60)) / 1000
        );

        // Format output as HH:MM:SS
        const formattedfinalcalcFacultyOT = [
          String(hoursfinalcalcFacultyOT).padStart(2, '0'),
          String(minutesfinalcalcFacultyOT).padStart(2, '0'),
          String(secondsfinalcalcFacultyOT).padStart(2, '0'),
        ].join(':');
  ...
  const calculateTotalRenderedTimeAM = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeAM
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
    ...
    // Return computed time
    const overallTimeAM = `${String(totalHours).padStart(2, '0')}:${String(
      totalMinutes
  ...
  const calculateTotalRenderedTimeTardinessAM = () => {
    ...
    attendanceData.forEach((row) => {
      const facultyRenderedTimeTardinessAM =
        !row.officialTimeIN ||
        !row.breaktimeIN ||
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeTardinessAM
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimePM = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimePM
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
    ...
    // Return computed time
    const overallTimePM = `${String(totalHours).padStart(2, '0')}:${String(
      totalMinutes
    ).padStart(2, '0')}:${String(totalSecs).padStart(2, '0')}`;
  ...
  const calculateTotalRenderedTimeTardinessPM = () => {
    ...
    attendanceData.forEach((row) => {
      const facultyRenderedTimeTardinessPM =
        !row.officialBreaktimeOUT ||
        !row.timeOUT ||
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeTardinessPM
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimeHN = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeHN
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimeTardinessHN = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeTardinessHN
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimeSC = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeSC
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimeTardinessSC = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeTardinessSC
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimeOT = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeOT
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
  ...
  const calculateTotalRenderedTimeTardinessOT = () => {
    ...
    attendanceData.forEach((row) => {
      ...
      const [hours, minutes, seconds] = facultyRenderedTimeTardinessOT
        .split(':')
        .map(Number);
      totalSeconds += hours * 3600 + minutes * 60 + seconds;
    });
