...
router.post('/vocational-table', (req, res) => {
  ...
  const query =
    'INSERT INTO vocational_table (vocationalNameOfSchool, vocationalDegree, vocationalPeriodFrom, vocationalPeriodTo, vocationalHighestAttained, vocationalYearGraduated, person_id) VALUES (?, ?, ?, ?, ?, ?, ?)';
  db.query(
    query,
    [
      vocationalNameOfSchool,
...
router.put('/vocational-table/:id', (req, res) => {
  ...
  const query =
    'UPDATE vocational_table SET vocationalNameOfSchool = ?, vocationalDegree = ?, vocationalPeriodFrom = ?, vocationalPeriodTo = ?, vocationalHighestAttained = ?, vocationalYearGraduated = ?, person_id = ? WHERE id = ?';
  db.query(
    query,
    [
      vocationalNameOfSchool,
